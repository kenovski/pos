...
$pon = "insert into posales(date,itemname, qty,unitprice,waiter,recno,cashier,category)values(curdate(),'$pname','$qty','$crate', '$waiter', '$rec','$cashier','$cat')";
mysqli_query($don, $pon) or die('cant insert');

$pond = "insert into posalesarchive(date,itemname, qty,unitprice,waiter,recno,cashier,category)values(curdate(),'$pname','$qty','$crate',  '$waiter', '$rec','$cashier',$cat'')";
